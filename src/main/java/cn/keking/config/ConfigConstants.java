...
import org.ayound.nas.file.search.Configuration;
...
public class ConfigConstants {
	...
	private static String sourceFilePaths;
	private static String indexFilePath;
	private static String excludeFilePaths;
	...
	public static final String DOWNLOAD_HEADER = "downloadKey";
	...
	@Value("${file.search.source.path:./files}")
	public void setSourceFilePathsValue(String sourceFilePathsValue) {
		sourceFilePaths = sourceFilePathsValue;
	}

	@Value("${file.search.data.path:./data}")
	public void setIndexFilePathValue(String indexFilePathValue) {
		indexFilePath = indexFilePathValue;
	}

	@Value("${file.search.exclude.path:}")
	public void setExcludeFilePathsValue(String excludeFilePathsValue) {
		excludeFilePaths = excludeFilePathsValue;
	}

	@Value("${file.search.download.key:}")
	public void setDownloadKeyValue(String downloadKeyValue) {
		ConfigConstants.downloadKey = downloadKeyValue;
	}
	...
	public static String getExcludeFilePaths() {
